 ...
 */
public class SettingsSWLicenseActivity extends AlertActivity {

    private static final String TAG = "SettingsSWLicenseActivity";
    private static final boolean LOGV = false || Config.LOGV;

    private static final String DEFAULT_LICENSE_PATH = "/system/etc/SW_NOTICE.html.gz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                mAlert.setTitle(getString(R.string.settings_sw_license_activity_title));
            }
        });

        final AlertController.AlertParams p = mAlertParams;
        p.mTitle = getString(R.string.settings_sw_license_activity_title);
        p.mView = webView;
